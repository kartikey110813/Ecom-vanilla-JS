if ('serviceWorker' in navigator) {
    navigator.serviceWorker
      ...
      firebase.auth().onAuthStateChanged(function(user) {
        if (user) {
          ...
          document.getElementById("suh").innerHTML = `Cart Added By ${firebase.auth().currentUser.displayName}`
       ...
       <div class="cardstyling col-lg-4 col-sm-6 portfolio-item">
         <div class="card h-100">
           ...
           <div class="card-body">
             ...
             <h6 class = "myquantity">Quantity = ${data.quantity}</h6>
    ...
    function deleteFavourite(key, button) {
      ...
      var favouritesRef = database.ref('cart/' + firebase.auth().currentUser.uid + `/` + key).set({});
  ...
  fetch(`https://transera-a3e20.firebaseio.com/cart/${userId}.json`)
      .then(data => {
